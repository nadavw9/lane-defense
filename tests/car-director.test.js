...
describe('HP clamping', () => {
  it('clamps to HP_MINIMUM (4) when formula would produce less', () => {
    // worldConfig.hpMultiplier = 0.05 forces rawHp ≈ 9 × 0.05 × 0.7 × 0.9 ≈ 0.28
